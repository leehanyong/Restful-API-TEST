...
public final class BinaryConvert
{
	
	/** The BAS e64_ alphabe t_ byte. */
	private  final byte BASE64_ALPHABET_BYTE[] = new byte[255];
	
	/** The BAS e64_ alphabe t_ char. */
	private  final char BASE64_ALPHABET_CHAR[] = new char[64];
	
	/**
	 * Instantiates a new convert binary.
	 */
	 ...
	 */
	public  String convertStringToBlob(Blob blob)
	throws SQLException, IOException
	{
		...
		return convertStringToBinary(buffer);
	}
	 ...
	 * @return the string
	 */
	public  String convertStringToBinary(byte[] binary)
	{
		if( binary == null )
			return null;
		
		char binaryChar[] = convertCharToByte(binary);
		if( binaryChar == null )
			return null;
	 ...
	 * @return the byte[]
	 */
	public  byte[] convertBinaryToString(String binary)
	{
		return convertByteToString(binary);
	}
	 ...
	 * @return the byte[]
	 */
	private  byte[] convertByteToString(String binary)
	{
		if(binary == null)
            return null;
        char ac[] = binary.toCharArray();
	 ...
	 */
    private  boolean isPad(char c)
    {
        return c == '=';
    }
    
	private  int removeWhiteSpace(char ac[])
    {
        if(ac == null)
            return 0;
        int i = 0;
	 ...
	 * @return the char[]
	 */
	private  char[] convertCharToByte(byte binary[])
    {
        if( binary == null )
            return null;
